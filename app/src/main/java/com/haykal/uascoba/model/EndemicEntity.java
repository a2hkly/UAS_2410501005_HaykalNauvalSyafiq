package com.haykal.uascoba.model;
...
public class EndemicEntity {
    ...
    public EndemicEntity(@NonNull String id, String tipe, String nama, String nama_latin, String famili, String genus, String deskripsi, String asal, String sebaran, String foto, String sumber_foto, String vidio, String sumber_vidio, String status) {
        this.id = id;
        this.tipe = tipe;
        this.nama = nama;
    ...
    public void setNama_latin(String nama_latin) { this.nama_latin = nama_latin; }
    ...
    public String getSumber_foto() { return sumber_foto; }
    public void setSumber_foto(String sumber_foto) { this.sumber_foto = sumber_foto; }

    public String getVidio() { return vidio; }
    public void setVidio(String vidio) { this.vidio = vidio; }

    public String getSumber_vidio() { return sumber_vidio; }
    public void setSumber_vidio(String sumber_vidio) { this.sumber_vidio = sumber_vidio; }
