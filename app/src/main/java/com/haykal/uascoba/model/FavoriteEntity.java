...
public class FavoriteEntity {
    ...
    public FavoriteEntity(@NonNull String id, String tipe, String nama, String nama_latin, String famili, String genus, String deskripsi, String asal, String sebaran, String foto, String sumber_foto, String vidio, String sumber_vidio, String status) {
        this.id = id;
        this.tipe = tipe;
        this.nama = nama;
